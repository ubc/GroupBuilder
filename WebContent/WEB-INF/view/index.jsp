...
<p id="tinyfootnote">GroupBuilder v1.1.0: Open source project, available on <a href="https://github.com/ubc/GroupBuilder" target="_blank">Github</a>.<br/> Special thanks to Bob Walker.</p>
